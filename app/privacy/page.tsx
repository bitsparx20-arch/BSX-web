...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-gradient-to-r from-black via-gray-900 to-gray-800 pt-28">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-3 sm:mb-4 leading-tight tracking-tight">
            <span className="block mb-2 bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">
              Privacy Policy
            </span>
            <span className="block text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-gray-300 tracking-wide">
              Your Privacy Matters to Us
            </span>
          </h1>
          
          <div className="relative">
            <p className="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed font-light tracking-wide px-4 relative z-10">
        ...
        <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 md:p-12 shadow-xl border border-gray-700/50">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="bg-gray-700 rounded-lg p-4">
                <p className="text-gray-300"><strong className="text-white">Email:</strong> bitsparx20@gmail.com</p>
                <p className="text-gray-300"><strong className="text-white">Email:</strong> admin@bitsparx.com</p>
                <p className="text-gray-300"><strong className="text-white">Company:</strong> Bitsparx</p>
                <p className="text-gray-300"><strong className="text-white">Location:</strong> Mumbai, India</p>
              </div>
            </div>
          </section>
